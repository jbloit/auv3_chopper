...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 135.0, 147.0, 244.0, 23.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 215.0, 288.0, 130.0, 25.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 167.0, 281.5, 24.0, 24.0 ],
					"presentation_rect" : [ 45.0, 178.5, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 167.0, 336.0, 78.0, 23.0 ],
					"style" : "",
					"text" : "qmetro 100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 167.0, 366.0, 51.0, 23.0 ],
					"style" : "",
					"text" : "getcpu"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 257.0, 336.0, 150.0, 23.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 167.0, 530.0, 131.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 167.0, 500.0, 85.0, 23.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 167.0, 470.0, 66.0, 23.0 ],
					"style" : "",
					"text" : "route cpu"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 75.0, 279.0, 54.0, 23.0 ],
					"style" : "",
					"text" : "knob $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 75.0, 193.0, 104.0, 21.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 75.0, 220.5, 189.0, 32.5 ],
					"size" : 1.0,
					"style" : ""
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 687.0, 127.0, 31.0, 21.0 ],
									"style" : "",
									"text" : "rate"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 466.0, 127.0, 49.0, 21.0 ],
									"style" : "",
									"text" : "repeats"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 253.0, 127.0, 59.0, 21.0 ],
									"style" : "",
									"text" : "crossings"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 441.666656, 83.0, 84.0, 23.0 ],
									"style" : "",
									"text" : "scale 0 1 1 11"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 658.0, 79.0, 84.0, 23.0 ],
									"style" : "",
									"text" : "scale 0 1 1 50"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 225.333328, 83.0, 84.0, 23.0 ],
									"style" : "",
									"text" : "scale 0 1 1 20"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 225.333328, 18.0, 262.0, 23.0 ],
									"style" : "",
									"text" : "param @name knob @default 0 @min 0 @max 1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 9.0, 792.0, 37.0, 23.0 ],
									"style" : "",
									"text" : "out 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 9.0, 18.0, 198.0, 23.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 9.0, 153.0, 668.0, 626.0 ],
									"style" : ""
								}
...
,
					"patching_rect" : [ 23.0, 431.5, 163.0, 23.0 ],
					"saved_object_attributes" : 					{
						"exportfolder" : "Macintosh HD:/Users/bloit/repos/auv3_juce_chopper/",
						"exportname" : "GenChopper"
					}
,
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 45.5, 147.0, 70.0, 23.0 ],
					"style" : "",
					"text" : "exportcode"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 1 ],
					"midpoints" : [ 32.5, 530.5, 47.5, 530.5 ],
					"order" : 1,
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 32.5, 529.5, 88.75, 529.5 ],
					"order" : 0,
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 176.5, 323.75, 176.5, 323.75 ],
					"order" : 1,
					"source" : [ "obj-21", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 176.5, 323.75, 266.5, 323.75 ],
					"order" : 0,
					"source" : [ "obj-21", 0 ]
				}
